# Dotazník Zelených Brno 2026 — aktuální podoba

**URL:** https://jakebrno.cz
**Odhadovaná délka:** ~6 minut
**Platforma:** vlastní implementace (HTML/JS/PHP/SQLite)

Tento dokument zachycuje skutečnou podobu dotazníku, jak je nasazený. Jde o referenční kopii — autoritativní zdroj je `index.html`.

---

## ÚVOD

> Co vás v Brně štve a co naopak za žádnou cenu nesmí zmizet? Z odpovědí Brňanů a Brňanek vznikne volební program Zelených pro komunální volby v říjnu 2026. Vyplnění zabere asi 6 minut.
...
*(volný text, volitelné — pokud E3a = „ano" nebo „občas")*
...
*(volný text, volitelné — pokud E4a = „ano" nebo „občas")*
...
*(checkbox — vícenásobně, slouží jako gateway pro celý blok G)*
...
**G1c. Narazili jste vy nebo vaši blízcí na problém s kapacitou středních škol v Brně?**
*(radio — školák ZŠ nebo SŠ)*
...
*(checkbox — předškolák nebo školák ZŠ)*
...
*(volný text, volitelné — pokud H1a = spíše nespokojen/a nebo nespokojen/a)*
...
*(volný text — pokud I1 = spíše nebezpečně / velmi nebezpečně)*
...
**N1. Jsem:** muž · žena · jiné · nechci odpovědět

**N2. Věková skupina:** 18–24 · 25–34 · 35–44 · 45–54 · 55–64 · 65+
...
**N4. Bydlím v:** vlastním bytě · nájemním bytě · družstevním bytě · vlastním domě · nájemním domě · jiné · nechci odpovědět

**N5. Část Brna, kde bydlím** *(rozbalovací menu)*
- **Brno-střed** rozdělené: Staré Brno · Veveří · Trnitá · Štýřice · Zábrdovice · Město (centrum)
...
**N6. Koho jste volili v posledních sněmovních volbách (2025)?** *(volitelná)*
- SPOLU (ODS, TOP09, KDU-ČSL) · ANO · Piráti + Zelení · STAN · SPD · Motoristé sobě · STAČILO · jiná strana · nevolil/a · nepamatuji si · nechci odpovědět

---

## ZÁVĚR

> Děkujeme. Vážíme si toho. Vaše odpovědi se promítnou přímo do programu, se kterým půjdeme do říjnových voleb.
...
- Klíče v JSONu odpovídají ID otázek (např. `a4`, `e1`, `n5`). Volnočtené pole „jiné" se ukládá pod `*-other` (např. `a2-other`, `c1-other`).
- Multiselect odpovědi se ukládají jako pole stringů (`["zelené","živé","kulturní"]`); radio jako string.
- `utm_source`, `utm_medium`, `utm_campaign`, `utm_content`, `utm_term` se sbírají automaticky z URL při prvním načtení.
- Průběžné ukládání: po každém přepnutí stránky se POSTuje aktuální stav na `/save.php` (status `partial`); po finálním odeslání `complete`.
- Anonymita: identifikátor respondenta je UUID v `localStorage`, nikoliv osobní údaj. E-mail je dobrovolný a sbírá se jen se souhlasem.
